...
const BasketScreen = () => {
    ...
    //If the value of the item isn't it won't recoount the value
    useEffect(() => {
        const groupedItems = items.reduce((results, item) => {
            //Create an object if the key exists then push item into that key ????
        ...
        <SafeAreaView className="flex-1 bg-white">
            <View className="flex-1 bg-gray-100">
                ...
                <View className="flex-row items-center space-x-4 px-4 py-3 bg-white my-5">
                    ...
                    />
                    <Text className="flex-1">Deliver in 40-50 mins</Text>
                    <TouchableOpacity>
